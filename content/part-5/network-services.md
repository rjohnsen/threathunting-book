...
Most operating systems come with a list of network services hidden deep within their file hierarchies. I’ve found these files extremely useful for understanding the base system I’m working on. For Windows, the services list can be found at:  `C:\Windows\System32\drivers\etc\services`.  

Linux has a similar, but more comprehensive, list located at: `/etc/services`.

For this cheat sheet, I’ve included the Windows version, but if you need a more exhaustive list, check out the _"IANA Service Name and Transport Protocol Port Number Registry"_ in the reference section.
